...
public class ConfigureProviderManager {
	...
	private static String CLASS = ConfigureProviderManager.class.getSimpleName();
    ...
    public static void configureProviderManager() {
        ...
        try {
            ...
            Log.w(CLASS, "Can't load class for org.jivesoftware.smackx.packet.Time");
        }
        ...
        try {
            ...
            Log.w(CLASS, "Can't load class for org.jivesoftware.smackx.packet.Version");
        }
        //  VCard
